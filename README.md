...
Backend för [Nagster](https://github.com/josefanderberg/nagster-web), en anti-prokrastineringsapp med rösttjat. Ett REST-API byggt med ASP.NET WebAPI och SQLite. Både webbappen och (senare i kursen) mobilappen hämtar sin data härifrån.
